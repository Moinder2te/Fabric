package net.liam.biomsofinfinity.util;
...
public interface ImplementedInventory extends Inventory {
    ...
    static ImplementedInventory ofSize(int size) {
        return new SimpleImplementedInventory(size);
    }
    ...
    class SimpleImplementedInventory implements ImplementedInventory {
        private final DefaultedList<ItemStack> items;

        private SimpleImplementedInventory(int size) {
